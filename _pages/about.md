...
<!-- Paper 6 -->
  <li style="margin-bottom: 0.45rem; line-height: 1.35; color: #202428;">
    ...
    <!-- Clean, unbroken inline structure for paper link -->
    <span style="color: #4589ff; margin-left: 4px;">[</span><a href="https://drive.google.com/file/d/1DcvSQVrGgHYis6B2f2ZtVvhn-DIS7Jcm/view?usp=sharing" target="_blank" rel="noopener noreferrer" style="color: #4589ff; text-decoration: none;">paper</a><span style="color: #4589ff;">]</span>  
    ...
    <details style="display: inline;">
      ...
      <!-- FIXED: Changed to display: block span to drop underneath cleanly without altering elements above it -->
